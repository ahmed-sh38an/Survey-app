<template>
  <PageComponent>
    ...
    <div v-if="surveys.loading" class="flex justify-center items-center"> Loading... </div>
    <div v-else>
      ...
      <div class="flex justify-center mt-5">
        <nav class="relative z-0 inline-flex justify-center rounded-md shadow-sm"
          ...
          <a
            ...
            aria-current="page"
            class="relative inline-flex items-center px-4 py-2 border text-sm font-medium whitespace-nowrap cursor-pointer"
            :class="[
              link.active
