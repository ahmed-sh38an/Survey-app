  ...
  <div class="flex items-center justify-between">
    ...
    <div class="flex items-center">
      ...
      <button
        ...
        class="flex items-center text-xs ml-2 py-1 px-2 rounded-md border border-transparent text-red-500 hover:border-red-600"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
  ...
  <div class="grid gap-3 grid-cols-12">
    ...
    <div class="mt-3 col-span-3">
      ...
      <select
        ...
        v-model="model.type"
        @change="typeChange"
        class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none sm:text-sm focus:border-indigo-500 focus:ring-indigo-500"
      >
